...
var CourseService = /** @class */ (function (_super) {
    ...
    function CourseService() {
        var _this = _super.call(this, course_model_1.default) || this;
        _this.hardDelete = function (courseId) { return __awaiter(_this, void 0, void 0, function () {
            var err, res, e_1;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        */
                        ...
                        return [4 /*yield*/, course_model_1.default.findByIdAndDelete(courseId)];
                    case 1:
                        res = _a.sent();
                        if (err)
                            throw err;
                        if (!res)
                            throw Error("No se ha borrado el curso");
        ...
        _this.lectionEraser = function (courseId) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, lection_model_1.default.deleteMany({ course: courseId })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, true];
                    case 2:
