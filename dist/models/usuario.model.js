...
usuarioSchema.plugin(mongoose_history_1.default);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    salt = crypto_1.randomBytes(32);
                    return [4 /*yield*/, argon2_1.default.hash(password, { salt: salt })];
                case 1:
...
usuarioSchema.methods.validPassword = function (password) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, argon2_1.default.verify(this.password, password)];
